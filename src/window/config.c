...
static generic_button checkbox_buttons[] = {
    ...
    { 20, 270, 20, 20, toggle_switch, button_none, CONFIG_GP_FIX_IMMIGRATION_BUG },
    { 20, 294, 20, 20, toggle_switch, button_none, CONFIG_GP_FIX_100_YEAR_GHOSTS },
};
...
static void draw_background(void)
{
    ...
    text_draw(string_from_ascii("Gameplay changes"), 20, 251, FONT_NORMAL_BLACK, 0);
    text_draw(string_from_ascii("Fix immigration bug on very hard"), 50, 275, FONT_NORMAL_BLACK, 0);
    text_draw(string_from_ascii("Fix 100-year-old ghosts"), 50, 299, FONT_NORMAL_BLACK, 0);
